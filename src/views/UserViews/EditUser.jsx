            ...
            <ScrollView contentContainerStyle={{ paddingBottom: 30 }}>
                ...
                <View className="items-center mt-2 mb-4">
                    <View className="relative">
                        ...
                        />
                        <TouchableOpacity
                            className="absolute bottom-2 right-2 bg-primary-light rounded-full p-1"
                            onPress={() => {}}
                        >
                            <PencilIcon size={18} color="#fff" />
                        </TouchableOpacity>
                    </View>
                    <Text className="text-lg font-bold text-center mt-2">{nombre}</Text>
                </View>
                ...
                <View className="px-6 mt-6">
                    <TouchableOpacity
                        className="bg-primary-light rounded-xl py-4"
                        onPress={handleSave}
                        activeOpacity={0.85}
                        disabled={loading}
                    >
