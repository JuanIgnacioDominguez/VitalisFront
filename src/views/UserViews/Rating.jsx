...
export default function Rating({ navigation }) {
    ...
    return (
        ...
        <ScrollView className="px-6 pt-14 pb-10 space-y-10">
            ...
            <Text className="text-primary-light text-2xl font-bold flex-1 text-center mr-8 mb-5">
                Calificación
            </Text>
            </View>
            <View>
            <Text className="text-lg text-primary-light font-bold mb-5">Calificar la app</Text>
            <Text className="text-base text-gray-500 mb-5">¿Qué te pareció la app?</Text>
